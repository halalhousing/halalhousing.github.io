...
<html lang="en-us">
  <head>
    ...
    <meta name="keywords" content="Interest Free Housing, Halal Housing, Muslim Housing, Islamic Finance">
    <meta name="description" content="Halal Housing provides Interest Free Housing Scheme for the Indian Muslims who do not want to go with conventional Bank Loans.">
    <meta name="author" content="Halal Venturez">
    <title>Halal Housing - A Housing Scheme for the Faithful</title>
  ...
  <body>
    <section class="page-header">
      <h1 class="project-name">Halal Housing - A Scheme for the Faithful</h1>
      <h2 class="project-tagline">Are you dreaming to own a house without going for a Bank Loan?</h2>
    </section>

    <section class="main-content">
      <p><b>Bismillahir Rahmaanir Raheem</b> - <em>In the Name of Allah the Most Beneficent, The Most Merciful!!</em></p>
...
<p>If there is a will there are multiple ways. Owning a decent flat in metropolitan cities of India through Halal means is no longer a distant dream. After so many years of patient waiting, contemplation and ground work, we are finally able to arrive at launching housing projects under the banner of <strong>Halal Housing</strong> - a novel housing scheme for the truly faithful. It is a hard reality that many of our brothers and sisters are still not in a position to have a own house in spite of a decent earning for the simple reason that they don’t want to go against the tenets of Islam by taking a conventional home loan from a Bank and fall into the traps of paying interest for the rest of their lives. <strong>Halal Housing</strong> is the result of their patient waiting and putting their complete trust in Allah. </p>

<p>Here is the gist of this novel scheme - Pay a minimum of 36% upfront of the total cost and balance in maximum 36 EMI’s (Interest FREE) which is <em>Three Years</em>. For example, if the total cost of a flat is 30 lakhs, then you pay 10.80 lakhs (36%) minimum upfront payment and the balance 19.20 lakhs in maximum 36 <strong>Interest FREE</strong> EMI’s of approximately <strong>Rs.53,333/-</strong> each. We are sure this sounds very attractive and irresistible, <em>Alhamdulillah</em>.</p>

<p><em>Alhamdulillah</em>, under this scheme we have already completed one project in Bannerghatta Road, Bangalore and we are just starting our next project in the same vicinity but in a much bigger area. Our mission is to create more and more such projects, that will make housing affordable, simple and enjoyable. Allah has helped us to start our third project in parallel in Old Madras Road.</p>
...
<td>Project Name</td>
<td>
<strong>Ecstasy</strong>, the third PREMIUM project under the Halal Housing Scheme</td>
</tr>
<tr>
<td>Location</td>
...
<tr>
<td>No. of Flats</td>
<td>13 flats, Car Parking in the Stilt, 4 flats per floor * three floors. One Pent house on the terrace</td>
</tr>
<tr>
<td>Avg. Area per Flat</td>
<td>Around 1100 SFT Spacious Flat with ample lighting and ventilation</td>
</tr>
<tr>
<td>Amenities</td>
...
<td>Project is already Started from 1st September 2016, alhamdulillah and estimated to be completed within 18 months from commencement. Possession in the month of <strong>February 2018</strong>, <em>in shaa Allah</em>.</td>
</tr>
</tbody>
</table>
...
<p>Ecstasy is located in the Heart of Neo Bangalore, in a 20 acre BMRDA Approved Layout, just 200 meters off new Mumbai-Chennai Express Corridor, Hoskote Town Limits.
With Very close proximities to MVJ Medical College of Hospital, Capstone High (Run by Samad Group Infantry Road, Bangalore)
Masjid-e-Mumtaz at Al Ameen residential Compound is just a stone throw away. The exact coordinate (Lat/Long), <strong>12°51'41.6"N 77°36'10.8"E</strong>. </p>
...
<p>Site visit can be arranged for brothers / sisters who want to come and see the place before making a flat booking. Please get in touch with one of our representatives through email halalhousing(at)gmail.com.</p>
...
<p>The pre-launch price per SFT is just <strong>INR 3,250/-</strong> (Three Thousand Two Hundred and Fifty ONLY). Kindly note that the typical price in that area (Off Old Madras Road) for similar flats is somewhere between INR 3800/- to 5500/- depending on the builder. As we are committed to make this Halal Housing project affordable to our brothers and sisters, we are offering the flats almost at the cost price without compromising on the quality of construction and materials used. All payments should be directly made in favor of Halal Venturez. The bank account details will be provided after signing the agreement.</p>
...
<p>Here is a simple calculator to know much you need to pay to own a flat in <strong>Ecstasy</strong>. The common area of 352 SFT is equally divided between four flats of each floor.</p>
...
<ul>
<li>The buyer will get into a Sale Agreement with <a href="http://abodeproperties.net/">Abode Properties</a>, the firm responsible for executing the project under the Banner of Halal Housing</li>
...
<li>Each flat owner will get individual <em>kaatha</em> and UDS (Un Divided Share) of land of roughly 370 SQ.FT with current value of around INR 13,00,000/- (Rupees Thirteen Lakhs Only)</li>
...
<li>Allotment of flats is solely at the discretion of <strong>Abode Properties</strong>
...
<p><em>Alhamdulillah</em>, Halal Housing Scheme not only provides the option of owning a house in the halal way and affordable means but also gives you the opportunity to live along with some wonderful pious Muslims. May Allah accept our efforts and help us in our endeavors, <em>aameen</em>. </p>

<br/><br/><em>Jazakallahu Khairan Katheer</em>, 
<br/>Halal Housing Team, 
<br/>Bangalore, INDIA.
<br/>Email: halalhousing(at)gmail.com
<br/>Mobile: 9900177377 (Mr.Asif, Coordinator)

<p>Please fill in the Online form to register your interest:</p>

<iframe src="https://docs.google.com/forms/d/1OlkAts_TLNA5DGelD5-kJQPQqah3UrGZMdFZtYYIbHg/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>

      <footer class="site-footer">

        <span class="site-footer-credits">Halal Housing - A Concept by <a href="#">Halal Venturez</a></span>
      </footer>
